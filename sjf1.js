...
let add_button = document.querySelector( ".container>div:last-child>.add-process>.add");    //   for adding process..
...
function tableCreate() {
  ...
  for (let i = 0; i < rowLength - 1; i++) {
    ...
    x.id = "c" + i;
    y.id = "cc" + i;
    x.innerHTML = array_process[i].pid;
    y.innerHTML = array_process[i].ct;
